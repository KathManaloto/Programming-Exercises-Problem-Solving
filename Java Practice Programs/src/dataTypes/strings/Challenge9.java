/*
    ...
    are repeated more than once, but retain the first occurrence of any case-insensitive
    repeated word.

    For example, the words love and to are repeated in the sentence:
    ...
    To solve this challenge, complete the following three lines:
        ...
        3. Write the two necessary arguments for replaceAll such that each repeated word is
    ...
    Each of the n subsequent lines contains a single sentence consisting of English
...
public class Challenge9 {
    ...
    public static void main(String[] args) {
        // 1. Regex for repeated words
        String regex = "\\b(\\w+)(\\s+\\1\\b)+";
        // 2. Compile with case-insensitive flag
        ...
        while (numSentences-- > 0) {
            ...
            // 3. Replace repeated words with first occurrence
