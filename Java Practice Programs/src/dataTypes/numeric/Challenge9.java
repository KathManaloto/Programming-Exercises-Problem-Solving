/*
    ...
    to exactly 10, the result is 10. Otherwise if the ab sum is exactly 
...
public class Challenge9 {
    ...
    public static void main(String[] args){
        ...
        System.out.println(ch.blueTicket(9, 1, 0));
        System.out.println(ch.blueTicket(9, 2, 0));
        System.out.println(ch.blueTicket(6, 1, 4));
    }
}
